...
define('ga_email','tvimp3.w@gmail.com');
define('ga_password','tvi$mail1');
define("MAX_RESULTS", 100);
require 'gapi.class.php';
$ids = array();
$result2 = mysql_query("SELECT `Google Profile ID` FROM `dealer-tvimp3.w` WHERE `Timestamp` < now() - INTERVAL 1 DAY ORDER BY `Index` ASC LIMIT ".MAX_RESULTS);
...
{
echo $id."<br/>";
$SQL = "UPDATE `dealer-tvimp3.w` SET `Report done` = `Report done` + 1 WHERE `Google Profile ID` = '$id'";		
		if (mysql_query($SQL)) {
			echo "saved";
		} else {
