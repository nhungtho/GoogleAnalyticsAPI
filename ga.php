+<?php
    ...
    $client_id = '947682284794-mtp5spninphi4vapfg32t7d8mqaf8iku.apps.googleusercontent.com';
    
    // From the APIs console
    $client_secret = 'ptlcs56zn6WZ23g3r16rYxCE';
    
     // Url to your this page, must match the one in the APIs console
    $redirect_uri = 'http://www.tvitest.com/analytics/ga.php';
 
    // Analytics account id like, 'ga:xxxxxxx'
    $account_id = 'ga:81491726';
